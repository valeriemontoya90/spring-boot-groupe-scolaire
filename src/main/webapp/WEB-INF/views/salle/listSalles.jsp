	...
	<div class="card border-primary mb-3" style="max-width: 30rem;">
		...
		<div class="card-body">
			<ul class="nav flex-column">
				<li class="nav-item"><a class="nav-link active" href="/salles/list">Gestion des salles</a></li>
				<li class="nav-item"><a class="nav-link" href="/salles/list">Liste des salles</a></li>
